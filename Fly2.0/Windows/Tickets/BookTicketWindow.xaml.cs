    ...
    public partial class BookTicketWindow : Window
    {
        ...
        private void BookingTicket_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                Airticket airticket = new Airticket(find_iduser.IdUser, ChoosenTicketType.IdTicketType, ChoosenFlight.IdFlight, GenerateTicketNumber(), GenerateSeatNumber(), price);
